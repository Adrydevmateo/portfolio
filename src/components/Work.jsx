    ...
    >
      <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full">
        ...
        <section className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
          ...
          <article
            style={{
              backgroundImage: `url(${"https://github.com/Adrydevmateo/password_generator/blob/master/public/preview.png?raw=true"})`,
            }}
            className="shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-card hover:scale-105 duration-300"
          >
            <section className="opacity-0 group-hover:opacity-100">
              ...
              <section className="pt-8 text-center">
                <a
                  href={"https://password-generator-five-tau.vercel.app/"}
                  target={"_blank"}
                >
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg">
                    Demo
                ...
                <a
                  href="https://github.com/Adrydevmateo/password_generator"
                  target={"_blank"}
                >
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg">
                    Code
          ...
          <article
            style={{
              backgroundImage: `url(${"https://github.com/Adrydevmateo/weather_app/blob/master/public/preview.png?raw=true"})`,
            }}
            className="shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center mx-auto content-card hover:scale-105 duration-300"
          >
            <section className="opacity-0 group-hover:opacity-100">
              ...
              <section className="pt-8 text-center">
                <a
                  href={"https://weather-app-drab-seven.vercel.app/"}
                  target={"_blank"}
                >
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg">
                    Demo
                ...
                <a
                  href="https://github.com/Adrydevmateo/weather_app"
                  target={"_blank"}
                >
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg">
                    Code
